...
public class ApiEmailService implements IEmailService {
    ...
    public boolean sendEmail(String to, String subject, String body) {
        ...
        System.out.println("Gửi email tới " + to + " thông qua API");
        return true;
    }

    @Override
    public boolean deleteEmail(String email) {
        System.out.println("Xóa email: " + email + " thông qua API");
        return true;
    }

    @Override
    public boolean editEmail(String email, String newEmail) {
        System.out.println("Chỉnh sửa email: " + email + " -> " + newEmail + " thông qua API");
        return true;
    }
}
